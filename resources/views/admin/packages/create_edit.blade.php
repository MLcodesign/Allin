...
<section class="content-header">
    <h1>
        <i class="fa fa-star"></i> {{ isset($package) ? '編輯' : '新增' }} 方案細項
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><i
                    class="fa {{ isset($package) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($package) ? '編輯' : '新增' }}
            方案
        </li>
    </ol>
</section>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('name', '方案細項名稱 *', ['class' => 'control-label col-md-3']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('cost', '費用 *', ['class' => 'control-label col-md-3']) !!}
                        <div class="col-md-9">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        {!! Form::label('cost_per', '單位 *', ['class' => 'control-label col-md-3']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('pricing_order', '顯示順序 *', ['class' => 'control-label col-md-3']) !!}
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-md-offset-3">
                            {!! Form::submit((isset($package)?'Update': 'Add'). ' 方案', ['class'=>'btn btn-primary']) !!}
                        </div>
                    </div>
                </div><!-- .col-md-6 -->
                <div class="col-md-6">
