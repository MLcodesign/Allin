...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'allindata/allin_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'allindata/allin_messages_','.xml');
}
...
function addKolorAnalytics(pPlugID) 
{
	...
	{
		var kolorAnalyticsJS = new ktools.Script("KolorAnalyticsJS", crossDomainTargetUrl+"allindata/graphics/KolorAnalytics/KolorAnalytics.min.js", [], true);
...
function addKolorMenu(pPlugID) 
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"allindata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"allindata/graphics/KolorMenu/KolorMenu.min.js", [], true);
...
function addKolorBox(pPlugID)
{
	...
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"allindata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"allindata/graphics/KolorBox/KolorBox.min.js", [], true);
