...
@section('content')
                        ...
                        <div class="caption1">
                            <div class="row">
                                ...
                                <div class="col-md-12  text-center">
                                    <h1>{{ $entry->page_title->data }}</h1>
                                    <h4>{{ $entry->page_subtitle1->data }}</h4>
                                    <h4>{{ $entry->page_subtitle2->data }}</h4>
                                </div>
                                <div class="btn1box">
                                    @if (Auth::guest())
                                        <div class="fl">
    ...
    <section id="pricing">
        <div class="container">
		  ...
		  ($i == 0) ? 4-count($packages) : 0}}">
                        ...
                        <div class="inner">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="{{ $package->features[3]->pivot->spec }}"
                                ...
                                <div class="col-md-12">
                                    <form action="{{ url('/schedule-new-box') }}" method="get">
                                    <!--{!! csrf_field() !!}
                                            <input type="hidden" value="{{ $package->id }}" name="package_id" />-->
                                        <input type="submit" class="btn btn-link text-uppercase" id="inner-button"
                                               value="立即預約">
                                    </form>
                                </div>
                            </div>
            ...
            <div class="row pricebox2">
                <div class="col-md-8 pboxborder">
                    <div class="col-sm-3 ">
                        <img src="/assets/dist/img/box5_s.png" class="img-responsive center-block">
                    </div>
                    <div class="col-sm-9 ">
                        <h3>{{ $entry->shipping_information_title->data }}</h3>
                        <small>
                            <p>{!! $entry->shipping_information_desc->data !!}</p></small>
                ...
                <div class="col-md-4">
                    ...
                    <div class="col-sm-14">
                        <h3>{{ $entry->addition_service_title->data }}</h3>
                        <small>
                            <p>{!! $entry->addition_service_desc->data !!}</p>
                        </small>
                    </div>
                    <div class="col-sm-12">
            ...
            <div class="row notes">
                <div class="col-md-12 f_pink">{{ $entry->notes->data }}</div>
                <div class="col-sm-12 hidden-xs">
                    <img src="/assets/dist/img/box_fee.jpg" class="img-responsive center-block">
                </div>
                <div class="col-xs-12 visible-xs text-center">
                    <img src="/assets/dist/img/box_fee1.png" class="img-responsive center-block">
                    <img src="/assets/dist/img/plus.png" class="img-responsive center-block">
                    <img src="/assets/dist/img/box_fee2.png" class="img-responsive center-block">
                    <img src="/assets/dist/img/plus.png" class="img-responsive center-block">
                    <img src="/assets/dist/img/box_fee3.png" class="img-responsive center-block">
                </div>
            </div>
        ...
        <div class="row notes">
            ...
            <div class="col-md-4 icon_notes">免費運送空箱</div>
            <div class="col-md-5 icon_notes">免費保險(每箱或每件大型物品最高理賠4000元)</div>
        </div>

        <img class="tabelimg" src="/assets/dist/img/table.jpg">	
		<img class="tabelimg" src="/assets/dist/img/table2.png">
