        ...
        <div class="row">
            <div class="col-md-6 space padd0">
                ...
                <div class="display width100">
                    <div class="col-md-4 col-sm-4 col-xs-4 padd0 display">
                        <img src="/allin_enter/images/shirt-img.jpg" width="100%" height="auto" alt="">
                    </div>
            ...
            <div class="col-md-6 space1 padd0">
                ...
                <div class="display padd0 width100">
                    ...
                    <div class="col-md-4 col-sm-4 col-sx-4 padd0 display">
                        <img src="/allin_enter/images/almira.jpg" width="100%" height="auto" alt="">
                    </div>
                </div>
                <div class="col-md-12 padd0">
