                                    <div class="item <?php if($x==0){echo "active";} ?>">
                                        <div class="box_select">
                                            <button type="button" class="add_cart add_to_cart" id="tab_add_to_cart_btn_{{$box->id}}" data-is-modal="0" data-type="slide" data-title="tab3_box" data-order-id="{{$box->order_id}}"  data-box-id="{{$box->id}}">移到貨車</button>
                                        </div>
                                        <div class="box_img_block">
                                            ...
                                            <input id="thumb_upload{{$box->id}}" class="none_block ajaximg" data-box-id="{{$box->id}}" data-type="slide" type='file' onchange="upload(this,'{{$box->id}}','{{$box->id}}');" />
                                            <div class="thumb_u_img thumb_u_{{$box->id}}" id="modal_{{$box->id}}">
                                                <div class="thumb_text" data-toggle="modal" data-target="#tab3_modal_slide_{{$box->id}}">
