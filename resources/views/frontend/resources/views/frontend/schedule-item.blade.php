  ...
  <div class="container" style="max-width:900px">
    <div class="row">
      ...
      <div class="col-xs-12"> @if (session('status'))
        ...
        @endif
        @if(count($boxes) > 0)
      <form method="post" action="{{url('/schedule-item')}}" id="submitforms" enctype="multipart/form-data">
          {!! csrf_field() !!}
        <div class="row pricebox3">
				...
				<div class="input-fields-row">
					...
					<div class="input-fields right">
						<div class="checkbox" id="checkp">
                            @if(NULL === $request->get('moving_floor'))
							<input name="moving_floor" id="moving_floor" type="checkbox"  value="100">是否搬運上下樓？(僅限有電梯大樓)   上樓搬運費 100點
                            @else
                            <input name="moving_floor" id="moving_floor" type="checkbox"  value="100" @if($request->get('moving_floor') == 100)checked @endif>是否搬運上下樓？(僅限有電梯大樓)   上樓搬運費 100點
                            @endif
          ...
          <div id="step-1" class="div-table morebox-drop">
            <div class="div-tr border-bottom">
              <div class="div-td morebox-drop-left"> <img id="dropoff-icon" src="/assets/dist/img/pickup-icon.png">
                <div id="dropoff" class="morebox-title morebox-questions"> 預約出倉取件
                  <div class="morebox-questions-description"></div>
                </div>
              </div>
              <div class="div-td morebox-drop-right">
          ...
          <div class="div-tr border-bottom text-center">
            ...
            <div class="div-td"> @if($request->get('action') === '預覽')
              <input type="button" id="btnSubmit" class="btn-primary morebox-continue btnSubmit" name="action" value="送出" style="width:100px"/>
              <input type="hidden" name="action" value="送出" />
              @else
              <input type="button" id="btnPreview" class="btn-primary morebox-continue btnSubmit" name="action" value="預覽" style="width:100px"/>
...
jQuery( "#datePicker" ).datepicker({ minDate: tomorrow, dateFormat: jdpDateFormat,  beforeShowDay: noSunday});
