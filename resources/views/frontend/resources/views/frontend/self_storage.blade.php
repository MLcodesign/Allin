                        ...
                        <div class="caption1">
                            <div class="row">
                                ...
                                <div class="col-md-12  text-center">
                                    <h1>{{ $data->page_title->data }}</h1>
                                    <h4>{{ $data->page_subtitle1->data }}</h4>
                                    <h4>{{ $data->page_subtitle2->data }}</h4>
                                </div>
    ...
    <section id="pricing">
        <div class="container">
            ...
            <div class="row notes2">
                ...
                <div class="col-md-4 icon_notes col-md-offset-1">半年繳9折優惠</div>
                <div class="col-md-2 icon_notes col-md-offset-1">年繳8折優惠</div>
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(window).load(function() {
            ...
            $('.edm-container a').click(function(e){
                e.preventDefault();
