...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('admin/users') }}"><i class="fa fa-users"></i> 會於ㄢ</a></li>
        <li class="active"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('account_number', old('account_number', isset($user) ? $user->account_number: null), ['class' => 'form-control validate[required]', 'placeholder'=>'Account Number']) !!}
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            {!! Form::label('package_id', '儲值方案', ['class' => 'control-label col-md-3']) !!}
                            <div class="col-md-9">
