            ...
            <table class="container" border="0" cellpadding="0" cellspacing="0" width="700" bgcolor="#ffffff"
                ...
                <tr>
                    <td align="center" valign="top">
                        ...
                        <table class="container header" border="0" cellpadding="0" cellspacing="0" width="620"
                            ...
                            <tr>
                                <td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;" align="left">
                                    <a href="{{ url('')}}"><img src="/assets/dist/img/logo1.png"></a>
                                </td>
                            </tr>
                        </table>
                        <!-- /// Header -->
                                    ...
                                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620"
                                        ...
                                        <tr>
                                            <td class="cta-block__title"
                                                style="padding: 35px 0 0 0; font-size: 26px; text-align: center;">{{ $subject }}
                                            </td>
                                        </tr>
                                                ...
                                                <table class="container" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="cta-block__button" width="230" align="center"
                                                            style="width: 200px;">
                                                            <a href="{{ url('') }}" style="border: 3px solid #eeeeee;
                                                            color: #969696; text-decoration: none; padding: 15px 25px;
                                                            text-transform: uppercase; display: block; text-align:
                                                            center; font-size: 16px;">{{ getSetting('SITE_TITLE') }}</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <!-- / Info Bullets -->
                        <table class="container info-bullets" border="0" cellpadding="0" cellspacing="0" width="100%"
                               align="center">
                            <tr>
                                <td align="center">
                                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620"
                                        ...
                                        <tr>
                                                ...
                                                <table class="container" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td class="info-bullets__icon" style="padding: 0 15px 0 0;">
                                                            <img src="/assets/dist/img/img13.png">
                                                        </td>

                                                        <td class="info-bullets__content"
                                                            style="color: #969696; font-size: 16px;"><a
                                            ...
                                            <td class="info-bullets__block" style="padding: 30px 30px 15px 30px;"
                                                ...
                                                <table class="container" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td class="info-bullets__icon" style="padding: 0 15px 0 0;">
                                                            <img src="/assets/dist/img/img11.png">
                                                        </td>

                                                        <td class="info-bullets__content"
                                                            style="color: #969696; font-size: 16px;">{{ getSetting('SUPPORT_PHONE') }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="620"
                                        ...
                                        <tr>
                                            <td style="text-align: center; padding: 50px 0 10px 0;">
                                                <a href="{{url('')}}"><img src="/assets/dist/img/banner2.png"></a>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td align="middle">
                                                <table width="60" height="2" border="0" cellpadding="0" cellspacing="0"
                                                       style="width: 60px; height: 2px;">
                                                    <tr>
                                                        <td align="middle" width="60" height="2"
                                                            style="background-color: #eeeeee; width: 60px; height: 2px; font-size: 1px;">
                                                            <img src="/assets/dist/img/img16.jpg"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="color: #d5d5d5; text-align: center; font-size: 15px; padding: 10px 0 60px 0; line-height: 22px;">
                                                Copyright &copy; 2016 <a href="{{ url('')}}" target="_blank"
                                                style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color:
                                                #d5d5d5;">ALL IN</a>. <br/>All rights reserved.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
